      ...
      <div className="grid grid-cols-1 md:grid-cols-2  lg:grid-cols-3  py-10">
        {skills.map((skill, idx) => (
          ...
          >
            ...
            <div className=" rounded-2xl h-full w-full p-4 overflow-hidden bg-linear-to-br from-slate-800 to-slate-800/20 border border-transparent group-hover:border-slate-700 relative z-50">
